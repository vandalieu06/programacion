//Variable que manteien el esatdo visible del carrtio
...
function ready(){
    //Agregamos funcionalidad a los botone de eliminar carrito
    ...
    let botonesRestarCantidades = document.getElementsByClassName('restarCarrito');
    ...
    document.getElementsByClassName('btnPagar')[0].addEventListener('click', pagarClicked)
}
